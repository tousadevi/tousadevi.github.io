...
WHERE logs.registrationid = registration.registrationid";
...
<script src="jscripts/requests.js"> </script>
 <body>
 <form  id = "userlog" method="Post" name = "userlog">
 <div id="banner"><img src="logg.jpg" width="100%" height="10%" alt="banner" />
</div>
 <table align = "center">
  <tr>
    <th>Firstname</th>
